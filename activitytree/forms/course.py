...
class CourseForm(forms.Form):
    ...
    rights = forms.CharField(label="Licencia", required=False, initial="Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)")
    is_private = forms.BooleanField(label="¿Es privado?", required=False, initial=False)
    rights_url = forms.URLField(label="URL de la licencia" , initial= 'https://creativecommons.org/licenses/by-sa/4.0/', required=False)
