if ! tmux has-session -t proto; then 
	...
	tmux send-keys -t proto:1.1 "tailwindcss -i input.css -o ./activitytree/static/assets/css/output.css --watch" Enter
	tmux send-keys -t proto:1.2 "python3 manage.py runserver" Enter
